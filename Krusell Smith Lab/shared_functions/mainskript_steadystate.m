...
[c_guess,m_star,joint_distr,R_fc,W_fc,Output,grid]=steadystate(P_H,grid,mpar,par,meshes);
...
cum_zero(2:end,2:end)=cum_dist;

Copula = griddedInterpolant({[0; marginal_m],[0; marginal_h']},cum_zero,'spline');
